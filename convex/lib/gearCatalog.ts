...
export const GEAR_CATALOG: GearCatalogItem[] = [
  ...
  { id: "ua-apollo-twin-x-duo", brand: "Universal Audio", model: "Apollo Twin X DUO (Heritage)", category: "interface", priceCents: D(899), note: "Thunderbolt, 2 Unison preamps", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Universal_Audio_Apollo_Twin_audio_interface_with_Realtime_UAD_Processing_and_Thunderbolt_-_2014_NAMM_Show_%28by_Matt_Vanacoro%29.jpg/960px-Universal_Audio_Apollo_Twin_audio_interface_with_Realtime_UAD_Processing_and_Thunderbolt_-_2014_NAMM_Show_%28by_Matt_Vanacoro%29.jpg", imageCredit: "Matt Vanacoro / Wikimedia Commons, CC BY 2.0" },
  ...
  // ── Microphones ──────────────────────────────────────────
  { id: "neumann-u87-ai", brand: "Neumann", model: "U 87 Ai", category: "mic", priceCents: D(3200), note: "Large-diaphragm condenser, 3 patterns", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/5/5c/Neumann_U87.jpg", imageCredit: "PJ / Wikimedia Commons, CC BY-SA 3.0" },
  ...
  { id: "akg-c414-xlii", brand: "AKG", model: "C414 XLII", category: "mic", priceCents: D(1199), note: "9 polar patterns", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/4/49/AKG-C414-front.jpg", imageCredit: "Iain Fergusson / Wikimedia Commons, CC BY 2.5" },
  ...
  { id: "shure-sm58", brand: "Shure", model: "SM58", category: "mic", priceCents: D(99), note: "Dynamic vocal", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/5/5c/Shure_SM58.jpg", imageCredit: "Iain Fergusson / Wikimedia Commons, CC BY 2.5" },
  ...
  { id: "royer-r121", brand: "Royer", model: "R-121", category: "mic", priceCents: D(1495), note: "Ribbon, guitar cabs", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Royer_121_%28201884599%29.jpeg/960px-Royer_121_%28201884599%29.jpeg", imageCredit: "Todd Williams / Wikimedia Commons, CC0" },
  ...
  { id: "krk-rokit-5-g5", brand: "KRK", model: "Rokit RP5 G5", category: "monitor", priceCents: D(199), note: "5-inch (each)", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/KRK_Rokit_5.jpg/960px-KRK_Rokit_5.jpg", imageCredit: "TaurusEmerald / Wikimedia Commons, CC BY-SA 4.0" },
  ...
  // ── Headphones ───────────────────────────────────────────
  { id: "sony-mdr-7506", brand: "Sony", model: "MDR-7506", category: "headphones", priceCents: D(99), note: "Closed-back studio standard", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Sony_MDR-7506_7615.jpg/960px-Sony_MDR-7506_7615.jpg", imageCredit: "Ashley Pomeroy / Wikimedia Commons, CC BY 4.0" },
  { id: "beyer-dt770-pro", brand: "Beyerdynamic", model: "DT 770 PRO", category: "headphones", priceCents: D(159), note: "Closed-back", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Beyerdynamic_DT_770_PRO_80_Ohm_-01.JPG/960px-Beyerdynamic_DT_770_PRO_80_Ohm_-01.JPG", imageCredit: "MMuzammils / Wikimedia Commons, CC BY-SA 3.0" },
  ...
  { id: "sennheiser-hd650", brand: "Sennheiser", model: "HD 650", category: "headphones", priceCents: D(499), note: "Open-back reference", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Sennheiser_HD650_headphones.jpg/960px-Sennheiser_HD650_headphones.jpg", imageCredit: "Lucasbosch / Wikimedia Commons, CC BY-SA 3.0" },
  ...
  { id: "moog-grandmother", brand: "Moog", model: "Grandmother", category: "synth", priceCents: D(999), note: "Semi-modular analog", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/c/ce/Moog_Grandmother_-_Guitar_Center_Silver_Spring_%282018-10-22_by_Kazuhisa_OTSUBO%29.jpg", imageCredit: "Kazuhisa OTSUBO / Wikimedia Commons, CC BY 2.0" },
  ...
  { id: "sequential-prophet-6", brand: "Sequential", model: "Prophet-6", category: "synth", priceCents: D(3299), note: "6-voice analog", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Sequential_Prophet-6_-_2015_NAMM_Show.jpg/960px-Sequential_Prophet-6_-_2015_NAMM_Show.jpg", imageCredit: "Brandon Daniel / Wikimedia Commons, CC BY-SA 2.0" },
  ...
  { id: "nord-stage-4-88", brand: "Nord", model: "Stage 4 88", category: "synth", priceCents: D(5499), note: "88-key stage keyboard", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Nord_Stage_4_keyboard_Chief_Adjuah_Vermont_Jazz_Center_72_Cotton_Mill_Hill_Brattleboro_VT_October_2025_02.jpg/960px-Nord_Stage_4_keyboard_Chief_Adjuah_Vermont_Jazz_Center_72_Cotton_Mill_Hill_Brattleboro_VT_October_2025_02.jpg", imageCredit: "Artaxerxes / Wikimedia Commons, CC BY 4.0" },
  ...
  { id: "apple-mac-mini-m4", brand: "Apple", model: "Mac mini (M4)", category: "computer", priceCents: D(599), note: "M4 · 16GB · 256GB SSD", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Mac_mini_2024_M4.jpg/960px-Mac_mini_2024_M4.jpg", imageCredit: "Seasider53 / Wikimedia Commons, CC BY 4.0" },
