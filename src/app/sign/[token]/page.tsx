      ...
      <div className="relative mx-auto w-full max-w-2xl">
        {data === undefined ? (
          ...
          <div className="rounded-chrome border border-graphite/50 bg-coal/60 p-8 text-center shadow-elev-2">
            ...
            <p className="mt-1 text-sm text-steel">It may have already been used or expired. Ask the studio to send a new link.</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <section className="rounded-chrome border border-graphite/50 bg-coal/60 p-5 shadow-elev-2">
              ...
              <p className="mt-1 text-xs text-steel">By typing your full legal name and signing below, you agree to the split percentages above. The studio captures the time you signed and your browser so the record is auditable.</p>
