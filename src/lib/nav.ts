...
export const NAV: NavItem[] = [
  ...
  { label: "Clients", href: "/roster", icon: Users, blurb: "Everyone the studio works with - artists, clients, leads" },
  { label: "Roster", href: "/roster?segment=artists", icon: Mic2, blurb: "The artists you develop and work with" },
  ...
  { label: "Schedule", href: "/schedule", icon: CalendarClock, blurb: "Staff shifts - who's working, in which room" },
