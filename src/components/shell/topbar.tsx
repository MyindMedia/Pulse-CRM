...
export function Topbar({ onOpenMenu }: { onOpenMenu: () => void }) {
  ...
  return (
    <header className="theme-dark-island sticky top-0 z-30 flex h-[calc(4rem_+_env(safe-area-inset-top))] items-center gap-3 border-b border-white/[0.08] bg-obsidian/65 px-4 pt-[env(safe-area-inset-top)] backdrop-blur-2xl backdrop-saturate-150 lg:px-6">
      <button
        onClick={onOpenMenu}
